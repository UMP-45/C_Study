...
if(fabs(a)<1e-6){printf("a=0,input again.the program will be stopped!\n");good=0;exit(0);}
...
else {printf("has not real roots,input again.the program will be stopped\n!");good=0;exit(0);}

}

void equation::show(){

printf("the coefficients of equation are: a=%f,b=%f,c=%f\n",a,b,c);
